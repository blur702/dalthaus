...
var require_plugin = __commonJS({
  "node_modules/tinymce/plugins/media/plugin.js"() {
    (function() {
      ...
      const defaultPromise = (data, dataToHtml2) => Promise.resolve({ html: dataToHtml2(data), url: data.source });
      ...
      const submitForm = (prevData, newData, editor) => {
        var _a;
        newData.embed = shouldInsertAsNewIframe(prevData, newData) && hasDimensions(editor) ? dataToHtml(editor, { ...newData, embed: "" }) : updateHtml((_a = newData.embed) !== null && _a !== void 0 ? _a : "", newData, false, editor.schema);
      ...
      const showDialog = (editor) => {
        ...
        const handleUpdate = (api, sourceInput, prevData) => {
          ...
          const data = shouldInsertAsNewIframe(prevData, dialogData) && hasDimensions(editor) ? { ...dialogData, embed: "" } : dialogData;
